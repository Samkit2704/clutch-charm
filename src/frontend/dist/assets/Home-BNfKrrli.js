import { r as reactExports, j as jsxRuntimeExports, S as Sparkles, B as Button, L as Link, a as SiWhatsapp, H as Heart, b as SiInstagram, u as useCartStore } from "./index-CzN1_jR2.js";
import { B as Badge } from "./badge-woc2LslZ.js";
import { u as useFeaturedProducts, S as Skeleton } from "./useQueries-BNCFLDIl.js";
import { s as setPageMeta, m as motion } from "./seo-FukVFP8Q.js";
import { A as ArrowRight, C as CircleCheckBig } from "./circle-check-big-CvFgBYn-.js";
import { S as Star, U as Users } from "./users-YnnM4DER.js";
...
function ProductCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl overflow-hidden shadow-subtle border border-border flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-24 mx-auto mt-1" })
    ] })
  ] });
}
function Home() {
  ...
  const displayProducts = (featuredProducts == null ? void 0 : featuredProducts.slice(0, 6)) ?? [];
      ...
      isError ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Couldn't load products. Please refresh to try again." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: isLoading ? ["sk-0", "sk-1", "sk-2", "sk-3", "sk-4", "sk-5"].map(
          ...
          ) : displayProducts.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
