...
Service({
  "getFeaturedProducts": Func([], [Vec(Product)], ["query"]),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    "getFeaturedProducts": IDL2.Func([], [IDL2.Vec(Product2)], ["query"]),
...
const products = [
  {
    ...
    price: 299,
    description: "A delicate handcrafted claw clutcher adorned with intricate rose petal detailing in soft blush pink. Perfect for everyday wear or special occasions.",
  ...
  },
  {
    ...
    price: 199,
    description: "A free-spirited boho clip with warm sunrise hues and hand-woven thread details. Effortlessly beautiful for any hairstyle.",
  ...
  },
  {
    ...
    price: 499,
    description: "A curated set of 4 pastel hair accessories — a clutcher, 2 mini clips, and a satin scrunchie — all in dreamy coordinating pastels.",
    materials: "Mixed materials, satin ribbon, alligator clips, gift box included",
    category: "Pastels",
    featured: true,
    image: IMG.flatlay
  },
  {
    ...
    price: 249,
    description: "A glamorous metallic gold hair pin with hand-placed rhinestone accents. Add instant luxury to any updo.",
  ...
  },
  {
    ...
    price: 279,
    description: "A soft lavender claw clutcher with hand-embroidered floral motifs. Gentle, romantic, and made with every detail in mind.",
  ...
  },
  {
    ...
    price: 229,
    description: "A whimsical floral clip inspired by wildflower crowns. Hand-shaped fabric petals in a burst of garden colors.",
  ...
  },
  {
    ...
    price: 319,
    description: "An eye-catching copper-toned clutcher with a twisted metallic sheen. Bold, modern, and uniquely handcrafted.",
  ...
  },
  {
    ...
    name: "Sky Blue Bow",
    price: 179,
    description: "A sweet sky blue satin bow with cloud-soft texture and a dainty pearl center. Perfect for little girls and the young at heart.",
  ...
  },
  {
    ...
    price: 289,
    description: "Inspired by vibrant marigold garlands, this golden clutcher brings festive joy to your everyday style.",
  ...
  },
  {
    ...
    price: 219,
    description: "A bold tribal-patterned boho clip with hand-knotted thread and earthy tones. Wear your free spirit with pride.",
  ...
  },
  {
    ...
    price: 269,
    description: "A dreamy silver hair pin dusted with micro-glitter stars. Twinkle in any light with this magical metallic piece.",
  ...
  },
  {
    ...
    price: 459,
    description: "A gorgeous pastel peach gift set — includes a claw clutcher, a ribbon bow, and 2 snap clips in matching peachy tones.",
    materials: "Mixed pastel materials, grosgrain ribbon, premium gift packaging",
    category: "Pastels",
    featured: true,
    image: IMG.flatlay
  }
...
function useFeaturedProducts() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return featuredProducts;
      try {
    ...
    enabled: !isFetching,
    staleTime: 5 * 60 * 1e3,
    placeholderData: featuredProducts
  });
}
function useProduct(id) {
  ...
  return useQuery({
    queryKey: ["product", id],
    queryFn: async () => {
      if (!actor) return getProductById(id) ?? null;
      try {
